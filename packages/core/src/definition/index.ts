  ...
  if (schemaEntry) {
    ...
    valueEntry =
      ofOption === null
        ...
        : ofOption === false
        ? undefined
        : getRefByOfChain(ctx, schemaEntry, ofOption);
  }
 ...
 */
export const getSchemaEntryByPath = (
  data: any,
  path: string[],
  ctx: CpuEditorContext,
  curEntry = '#',
  ...
  while (path.length > 0) {
    ...
    schemaEntry =
      getFieldSchema(nowData, valueEntry, mergedValueSchema, key) || undefined;
