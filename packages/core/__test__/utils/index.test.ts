...
describe('utils', () => {
  ...
  it('deepGet', () => {
    ...
    expect(deepGet(json, uri2strArray('#/properties/key/'))).toBe(
      json.properties.key,
    );
  ...
  it('deepSet', () => {
    ...
    expect(deepSet(cloneDeep(json), '#/properties/key/maxLength', 20)).toEqual(
      json2,
    );
    expect(deepSet(cloneDeep(json), '#/properties/key/', null)).toEqual(json3);
    expect(deepSet(cloneDeep(json), '#/properties/a/b/c/d', null)).toEqual(
      json4,
    );
  });
